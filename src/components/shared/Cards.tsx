    ...
    <div className="glass-card glass-card-interactive overflow-hidden flex flex-col group animate-fade-in">
      ...
      <div className="p-3 flex flex-col gap-2 flex-1">
        ...
        <div className="flex gap-2 mt-auto pt-2 border-t border-border/10">
          ...
          {company && (
            <a href={waUrl} target="_blank" rel="noopener noreferrer" className="btn-whatsapp text-2xs flex-1 py-1.5 font-bold rounded-lg shadow-sm">
  ...
  return (
    <div className="glass-card glass-card-interactive p-4 flex flex-col gap-3 group animate-fade-in">
      ...
      <div className="flex gap-2 mt-auto pt-2 border-t border-border/10">
        ...
        <a href={waUrl} target="_blank" rel="noopener noreferrer" className="btn-whatsapp text-2xs flex-1 py-1.5 font-bold rounded-lg shadow-sm text-center">
          WhatsApp
        </a>
      </div>
    </div>
