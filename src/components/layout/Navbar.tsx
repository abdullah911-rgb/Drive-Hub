        ...
        <div className="container-app">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-2.5 group">
              <div className="w-9 h-9 rounded-xl gradient-primary flex items-center justify-center text-white font-bold text-sm shadow-sm transition-transform duration-300 group-hover:rotate-6">
                <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
                </svg>
              </div>
              <div>
                <span className="font-heading font-black text-lg tracking-tight gradient-text leading-none block">DriveHub</span>
                <div className="text-[9px] text-slate-500 font-bold uppercase tracking-widest group-hover:text-primary transition-colors">Marketplace</div>
              </div>
            </Link>
              ...
              {loading ? (
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2 glass px-3.5 py-2 rounded-xl hover:border-primary/30 transition-all shadow-sm"
                  >
