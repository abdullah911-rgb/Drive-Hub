...
export default function Footer() {
  ...
  return (
    <footer className="relative isolate z-0 mt-0 overflow-hidden border-t border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-[#070B14]">
      <div
      ...
      <div className="container-app relative z-10 px-6 py-4 md:py-5">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="max-w-sm">
            ...
            <p className="mt-1.5 text-xs font-medium leading-snug text-slate-600 dark:text-slate-300">
          ...
          <div className="flex flex-col items-start gap-2.5 md:items-end">
            <nav aria-label="Footer" className="flex flex-wrap items-center gap-x-0.5 gap-y-0.5 md:justify-end">
              {navLinks.map((link, i) => (
            ...
            <div className="flex items-center gap-2">
              <Link href="/marketplace" className="btn-primary px-4 py-1.5 text-xs font-bold">
                Browse cars
              </Link>
              <Link
        ...
        <div className="mt-3 flex flex-col items-start justify-between gap-1 border-t border-slate-200 pt-2.5 sm:flex-row sm:items-center dark:border-slate-800">
